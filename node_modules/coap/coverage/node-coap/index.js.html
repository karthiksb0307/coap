...
<head>
    <title>Code coverage report for node-coap/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">node-coap</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
  if (url.agent)
    agent = url.agent
  else <span class="missing-if-branch" title="if path not taken" >I</span>if (url.agent === false &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!ipv6)</span>
<span class="cstat-no" title="statement not covered" >    agent = new Agent({ type: 'udp4' })</span>
  else <span class="missing-if-branch" title="if path not taken" >I</span>if (url.agent === false &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ipv6)</span>
<span class="cstat-no" title="statement not covered" >    agent = new Agent({ type: 'udp6' })</span>
  else if (ipv6)
