...
<head>
    <title>Code coverage report for node-coap/lib/observe_read_stream.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> observe_read_stream.js</h1>
        <div class='clearfix'>
...
ObserveReadStream.prototype.append = function(packet) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.readable)
