...
<head>
    <title>Code coverage report for node-coap/lib/option_converter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> option_converter.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">95.97% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>119/124</span>
            </div>
...
module.exports.toBinary = function(name, value) {
  if (Buffer.isBuffer(value))
    return value
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!optionToBinaryFunctions[name])
<span class="cstat-no" title="statement not covered" >    throw new Error('Unknown string to Buffer converter for option: ' + name)</span>
&nbsp;
...
var fromUint = function(result) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!isFinite(uint) || Math.floor(uint) !== uint || uint &lt; 0) {
<span class="cstat-no" title="statement not covered" >    throw TypeError('Expected uint, got ' + result)</span>
  }
  var parts = []
  while (uint &gt; 0) {
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Unknown Content-Format: ' + value)</span>
&nbsp;
  return result
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return formatsBinaries[0]</span>
&nbsp;
  if (value.length === 1)
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (buf.length === 2) {
<span class="cstat-no" title="statement not covered" >    result = buf.readUInt16BE(0)</span>
