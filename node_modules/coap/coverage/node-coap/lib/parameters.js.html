...
<head>
    <title>Code coverage report for node-coap/lib/parameters.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> parameters.js</h1>
        <div class='clearfix'>
...
p.refreshTiming = function(values) {
  for (var key in values){
    <span class="missing-if-branch" title="else path not taken" >E</span>if (p[key]) {
      p[key] = values[key]
    }
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (values &amp;&amp; (typeof(values.pruneTimerPeriod)==="number")) {
<span class="cstat-no" title="statement not covered" >    p.pruneTimerPeriod = values.pruneTimerPeriod</span>
  } else {
