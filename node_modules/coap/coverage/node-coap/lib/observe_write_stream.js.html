...
<head>
    <title>Code coverage report for node-coap/lib/observe_write_stream.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> observe_write_stream.js</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._counter === 16777215)
<span class="cstat-no" title="statement not covered" >    this._counter = 1</span>
&nbsp;
  this._doSend(data)
&nbsp;
  done()
