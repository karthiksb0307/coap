...
<head>
    <title>Code coverage report for node-coap/lib/helpers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> helpers.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">3293x</span>
...
&nbsp;
  result += first + '.'
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (second &lt; 10)
    result += '0'
&nbsp;
  result += second
&nbsp;
