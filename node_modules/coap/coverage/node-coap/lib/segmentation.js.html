...
<head>
    <title>Code coverage report for node-coap/lib/segmentation.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> segmentation.js</h1>
        <div class='clearfix'>
...
SegmentedTransmission.prototype.updateBlockState = function updateBlockState() {
  ...
  this.blockState.moreBlocks = ((this.currentByte + this.byteSize) &lt; this.totalLength)?<span class="branch-0 cbranch-no" title="branch not covered" >1:</span>0
&nbsp;
...
SegmentedTransmission.prototype.resendPreviousPacket = function resendPreviousPacket() {
  if(this.resendCount &lt; 5) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if(this.remaining() &gt; 0) {
...
SegmentedTransmission.prototype.receiveACK = function receiveACK(packet, retBlockState) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if(this.blockState.blockSize !== retBlockState.blockSize) {
<span class="cstat-no" title="statement not covered" >    this.setBlockSizeExp(retBlockState.blockSize)</span>
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if(this.remaining() &gt; 0) {
    this.sendNext()
  }
  this.resendCount = 0
}
...
<span class="cstat-no" title="statement not covered" >  this.req.sender.send(buf, !this.packet.confirmable)</span>
}
&nbsp;
&nbsp;
&nbsp;
