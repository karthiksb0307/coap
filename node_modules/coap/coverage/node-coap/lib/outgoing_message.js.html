...
<head>
    <title>Code coverage report for node-coap/lib/outgoing_message.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node-coap/lib</a> outgoing_message.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  packet.token = ''
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._ackTimer)
<span class="cstat-no" title="statement not covered" >    clearTimeout(this._ackTimer)</span>
&nbsp;
  this._send(this, packet)
&nbsp;
  // easy clean up after generating the packet
...
OutgoingMessage.prototype.writeHead = function(code, headers) {
  ...
  for (header in headers) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (headers.hasOwnProperty(header)) {
